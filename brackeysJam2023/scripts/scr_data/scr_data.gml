...
global.map_attacks[? "laser beam"]		= attack("laser beam",						9,	TYPES.eye,  ATT_SPEEDS.priority, global.map_sounds[?"laser"])
...
global.list_fighters[|FIGHTERS.laser_visor]=base_fighter("vetamerse",   spr_visor,  60, ATT_SPEEDS.fast+60, FIGHTER_ACC.high,   TYPES.eye,  [global.map_attacks[?"laser beam"]], [], bhvr_scroll, c_maroon);
