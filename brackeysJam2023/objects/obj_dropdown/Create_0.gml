...
buttons functions are automatically set to
function(){
	parent.return_value = return_value;
}

if you want to make the buttons do anything more specific than passing a value, put it in a switch in the dropdown function.

dropdown functions are usually kind of the same. the button that created it would give the dropdown a reference to itself as a parent,
