...
//draw sprite
draw_sprite_ext(my_fighter.sprite,0,wave(x-5,x+5,2,0)+random_range(-shake_remain,shake_remain),y+random_range(-shake_remain,shake_remain),_xs/2,1/2,0,c_white,1);
